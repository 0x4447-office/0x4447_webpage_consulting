            ...
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="card-body py-7 py-md-9 text-center text-lg-right">
                  ...
                  <!-- Text -->
                  <p class="text-muted mb-0">{{ about.card_1.text }}</p>
                </div>
              </div>
            </div>
            <!-- / .row -->
          ...
          >
            <div class="row">
              <div class="col-md-4 position-relative">
                <!-- Image -->
                <img
                  :src="`public${about.card_3.image}`"
                  class="h-75 position-absolute right-0 mt-6"
                  alt="Your Entire Team"
                />
              </div>
              <div class="col-md-8">
                <!-- Body -->
